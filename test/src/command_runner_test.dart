...
import 'package:ai_batch_gen/src/command_runner.dart';
...
void main() {
  group('AiBatchGenCommandRunner', () {
    late PubUpdater pubUpdater;
    late Logger logger;
    late AiBatchGenCommandRunner commandRunner;
    ...
    setUp(() {
      ...
      commandRunner = AiBatchGenCommandRunner(
        logger: logger,
    ...
    test(
      ...
      () {
        final commandRunner = AiBatchGenCommandRunner();
