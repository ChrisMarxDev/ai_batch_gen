  ...
  Future<Uint8List> generateImage({
    ...
    final response = await r.retry(() async {
      ...
      if (res.statusCode == 429 || res.statusCode >= 500) {
        throw http.ClientException('Retryable ${res.statusCode}: ${res.body}', uri);
      }
    ...
    final imgRes = await http.get(Uri.parse(url)).timeout(Duration(milliseconds: timeoutMs ?? 60000));
